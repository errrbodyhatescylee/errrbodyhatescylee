  ...
  try {
    ...
    if (contentType && contentType.startsWith('image')) {
      ...
      await m.bot.sendFromUrl(
        m.from,
        photoUrl,
        "*PHOTO GENERATED BY Chucky 2.0 ❄️❤️🧸*:",
        m,
        {},
        "image"
      );
...
smd(
  ...
  async (m) => {
    try {
      ...
      // Send a loading message
      await m.send("Chucky is still thinking, hold your balls for some seconds 🤔");
    ...
    async (_0x358984, _0x20693a, { smd: _0x12d243 }) => {
      try {
        ...
        await _0x358984.error(
          _0x51ed58 + "\n\ncommand: " + _0x12d243,
          _0x51ed58,
          "*_Can't send annonymously message yet, Sorry not sorry!!_*"
        );
      }
    }
  );
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("Chucky 2.0• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("Chucky 2.0• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*Chucky 2.0 • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
