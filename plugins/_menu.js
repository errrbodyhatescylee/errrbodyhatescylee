...
astro_patch.smd({
  ...
  try { 
    ...
    const header = "┏━━メ *" + Config.botname + "* メ━━✿︎\n";
    const lineSeparator = "┃ ";
    ...
    menuContent += lineSeparator + "❤️ *𝚄𝙿𝚃𝙸𝙼𝙴:* " + runtime(process.uptime()) + "\n";
    menuContent += lineSeparator + "❄️ *𝚁𝙰𝙼 𝚄𝚂𝙴:* " + formatp(os.totalmem() - os.freemem()) + "\n";
